 ...
 */
@TeleOp(name = "Force_Global Coordinate Position Test", group = "Calibration")
@Disabled
public class ForceGlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        globalPositionUpdate.reverseRightEncoder();     // CW
        globalPositionUpdate.reverseNormalEncoder();    // CW
