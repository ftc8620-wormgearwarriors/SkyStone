...
public class Swartz_Meet_One_Blue extends SkyStoneAutonomousMethods {
    ...
    public void runOpMode() {
        ...
        switch (StoneRember) {
            case 2: //SkyStone is offscreen Alan fixing
                strafe(180, 1);  //Sideways Under Bridge

                robot.OpenServo.setPosition(0.36);  // Open Claw
                sleep(400);     //way to big was 7 00     // Sleeping to drop block
                strafe(120, -1);  // Going Back to grab another block
                ...
                drive(18, -1);
                armExt(2000, 1);
                strafe(140, 1); //was 171
                robot.OpenServo.setPosition(0.36);
                strafe(40,1);
                drive(25,-1);
                break;
            case 1: //SkyStone is on the left
                strafe(130, 1);  //Sideways Under Bridge Fixing

                robot.OpenServo.setPosition(0.36);  // Open Claw
                sleep(400);     //way to big was 7 00     // Sleeping to drop block
                strafe(185, -1);  // Going Back to grab another block
            ...
            case 0: //SkyStone is on the right working
                strafe(110, 1);  //Sideways Under Bridge
